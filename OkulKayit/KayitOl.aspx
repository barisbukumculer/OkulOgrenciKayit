                ...
                <form action="#" method="post" runat="server">
                    ...
                    <div class="form-group">
                        <label class="col-form-label">Şifreniz</label>
                           <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" TextMode="Password" placeholder="*****"></asp:TextBox>
                    </div>
                    <div class="sub-w3l my-3">
                        <div class="sub-w3layouts_hub">
                            <input type="checkbox" id="brand1" value="">
                            <label for="brand1" class="text-li text-style-w3ls">
                                <span></span>Okudum ve Kabul Ediyorum.</label>
                        </div>
                    </div>
                    <asp:Button ID="Button" runat="server" Text="Kayıt Ol" class="btn btn-primary" OnClick="Button_Click" />
                </form>
            </div>
            <!-- //register -->
        </div>
